...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		BigDecimal estimatedHours = 
				getDecimalInput("Enter project estimated hours [" 
				+ curProject.getEstimatedHours() + "]");
		BigDecimal actualHours = 
				getDecimalInput("Enter project actual hours [" 
				+ curProject.getActualHours() + "]");
		Integer difficulty =
				getIntInput("Enter project difficulty (1-5) [" 
				+ curProject.getDifficulty() + "]");
		String notes = 
				getStringInput("Enter project notes [" 
				+ curProject.getNotes()+ "]");
